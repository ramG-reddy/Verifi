...
export default function VerifyCompanyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setResult({ exists: false, error: 'Failed to verify company' });
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] p-4">
        ...
        <div className="text-center mb-8 max-w-2xl">
          ...
          <p className="text-gray-600 text-lg">Verify SEBI registered companies and institutions</p>
        </div>
                      ...
                      <div className="border-t pt-4">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          <div>
                            ...
                            <p className="font-medium">{result.company.registration_id}</p>
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            <p className="font-medium">{result.company.status}</p>
                          </div>
                          <div>
                            <span className="text-gray-600">Type:</span>
                            <p className="font-medium">{result.company.company_type || 'N/A'}</p>
                          </div>
                        </div>
                      </div>
